#!/bin/bash
# Example forecast run using 20260623_run1 weights with Williamson case 6 ICs.
#
# Run from the repo root: bash scripts/example_forecast_wc6.sh
...
/home/avg000/miniconda3/envs/swan/bin/python forecast.py \
  ...
  --ic_type precomputed \
  --precomputed_folder /home/avg000/swan/datasets/train/williamson_case6_60_20260618 \
  --num_ics 1 \
  --autoreg_steps 40 \
